...
SERVICES = [
    ...
    ("Keyspaces", "Database", "Serverless, fully managed Apache Cassandra-compatible wide-column database service.", ["DynamoDB", "MemoryDB"]),
    ...
    ("DMS", "Database", "Database Migration Service that migrates databases to AWS with minimal downtime, including heterogeneous conversions.", ["RDS", "Aurora", "Redshift", "S3"]),
