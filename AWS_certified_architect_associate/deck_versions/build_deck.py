...
RICH_DESCRIPTIONS = {
    ...
    'Comprehend': 'NLP service that uncovers insights and relationships in text.<br><span style="background-color: rgba(0, 0, 0, 0); color: rgb(35, 43, 55);">* <b>Uncover valuable insights</b> from text in documents, customer support tickets, product reviews, emails, social media feeds, and more.&nbsp;<br>*&nbsp;</span><span style="color: rgb(35, 43, 55);"><b>Simplify document processing workflows</b> by extracting text, key phrases, topics, sentiment, and more from documents such as insurance claims.&nbsp;<br></span><span style="background-color: rgba(0, 0, 0, 0); color: rgb(35, 43, 55);">*&nbsp;</span><span style="color: rgb(35, 43, 55);"><b>Articulate your data</b> by training a model to classify documents and&nbsp;identify terms, with no machine learning (ML) experience required.&nbsp;<br></span><span style="background-color: rgba(0, 0, 0, 0); color: rgb(35, 43, 55);">*&nbsp;</span><span style="color: rgb(35, 43, 55);"><b>Protect and control ( PII discovery )</b> who has access to your sensitive data by identifying and redacting Personally Identifiable Information (PII) from documents.&nbsp;</span><span style="background-color: rgba(0, 0, 0, 0); color: rgb(35, 43, 55);"><br></span>',
    'Compute Optimizer': 'Recommends optimal AWS resources to reduce cost and improve performance using machine learning.<br><b>Benefits:</b><br>*&nbsp;<span style="background-color: rgba(0, 0, 0, 0); color: rgb(35, 43, 55);">Identify <b>under-provisioned resources</b> to help you resolve performance issues.<br>*&nbsp;</span><span style="color: rgb(35, 43, 55);">Identify <b>unused resources</b> with idle detection recommendations.<br></span>*&nbsp;<span style="color: rgb(35, 43, 55);">Get recommendations to help you choose optimal configurations for <b>over-provisioned resources</b>. Customize <b>rightsizing</b> recommendations for your specific workload needs and enable <b>CloudWatch agent</b> to unlock additional savings opportunities.<br></span>*&nbsp;<span style="background-color: rgba(0, 0, 0, 0); color: rgb(35, 43, 55);"><b>Automatically implement</b> recommendations on a recurring schedule whenever they match your criteria.<br><b>Use Cases:</b><br></span><span style="background-color: rgba(0, 0, 0, 0); color: rgb(35, 43, 55);">Identify <b>under-provisioned resources</b> to help you resolve performance issues.</span><span style="background-color: rgba(0, 0, 0, 0); color: rgb(35, 43, 55);"><br></span><span style="color: rgb(35, 43, 55);">Get recommendations to detect <b>unused resources</b> such as unattached EBS volumes, idle EC2 instances, and more.</span><span style="background-color: rgba(0, 0, 0, 0); color: rgb(35, 43, 55);"><br></span><span style="color: rgb(35, 43, 55);">Get recommendations to help you choose optimal configurations for <b>over-provisioned resources</b>. Customize <b>rightsizing</b> recommendations for your specific workload needs and enable CloudWatch agent to unlock additional savings opportunities.</span>',
    ...
    'ELB': '<div><div>AWS Elastic Load Balancing (ELB) is heavily tested across both Associate and Professional-level AWS exams. Examiners frequently focus on the distinct architectural differences, edge-case configurations, and subtle "gotchas" between Application Load Balancers (ALB), Network Load Balancers (NLB), and Gateway Load Balancers (GWLB).</div><h2>1. Core Structural Differences &amp; Layer Routing</h2><table><tbody><tr><td><strong>Feature</strong></td><td><strong>Application Load Balancer (ALB)</strong></td><td><strong>Network Load Balancer (NLB)</strong></td><td><strong>Gateway Load Balancer (GLB)</strong></td></tr><tr><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);"><b>OSI Layer</b></span></td><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);">Layer 7 (HTTP/HTTPS/gRPC)</span></td><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);">Layer 4 (TCP/UDP/TLS)</span></td><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);">Layer 3 (IP Packets)</span></td></tr><tr><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);"><b>IP Addressing</b></span></td><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);"><b>Dynamic IPs.</b> Changes over time. Requires a DNS name.</span></td><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);"><b>Static IPs.</b> One Elastic IP per Availability Zone.</span></td><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);">Dynamic or Static depending on endpoint routing.</span></td></tr><tr><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);"><b>Security Groups</b></span></td><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);"><b>Requires</b> an attached Security Group.</span></td><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);"><b>No Security Groups</b> attached directly to the load balancer.</span></td><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);">Uses VPC Endpoint services; no direct Security Groups.</span></td></tr><tr><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);"><b>Target Preservation</b></span></td><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);">Sees the ALB\'s internal IP (requires <code>X-Forwarded-For</code> for client IP).</span></td><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);">Sees the <b>true client IP</b> directly (by default for TCP targets).</span></td><td><span style="background-color: rgba(0, 0, 0, 0); color: rgb(31, 31, 31);">Preserves the original packet entirely using GENEVE encapsulation.</span></td></tr></tbody></table><h2>2. High-Frequency Exam Pinpoints &amp; "Gotchas"</h2><h3>Cross-Zone Load Balancing</h3><ul><li><div><b>ALB:</b> Enabled by default. Traffic is distributed evenly across all target instances in all registered AZs. There is <b>no data transfer charge</b> for inter-AZ traffic driven by an ALB.</div></li><li><div><b>NLB:</b> <b>Disabled by default.</b> If disabled, traffic hitting a specific NLB subnet endpoint stays within that AZ. Enabling Cross-Zone Load Balancing on an NLB eliminates regional imbalances but <b>incurs regional data transfer charges</b>.</div></li></ul><h3>Static IP Requirements</h3><ul><li><div>A classic scenario involves a legacy on-premises system or a third-party firewall that can only whitelist a single, fixed IP address.</div></li><li><div><b>The Gotcha:</b> You <b>cannot</b> assign an Elastic IP to an ALB. To achieve a static IP footprint for an HTTP application, you must architecture a solution using <b>AWS Global Accelerator</b> or front the ALB with an <b>NLB pointing to an ALB target group</b>.</div></li></ul><h3>Connection Draining (Deregistration Delay)</h3><ul><li><div>When an Auto Scaling Group terminates an instance, ELB puts the target into a <code>draining</code> state so active flights can finish.</div></li><li><div><b>The Gotcha:</b> The default timeout is <b>300 seconds (5 minutes)</b>. If an exam question describes a deployment that hangs or taking too long to complete a rolling updates phase, look for an answer that lowers the <code>deregistration_delay.timeout_seconds</code> attribute.</div></li></ul><h3>SSL/TLS Optimization</h3><ul><li><div><b>ALB:</b> Supports <b>Server Name Indication (SNI)</b>, allowing you to host multiple secure websites (with different SSL certificates) behind a single ALB.</div></li><li><div><b>NLB:</b> Ideal for extreme performance because it can handle <b>millions of requests per second</b> with ultra-low latency. It supports TLS termination directly at the NLB layer to offload compute from your instances.</div></li></ul><h3>Health Check Discrepancies</h3><ul><li><div><b>ALB:</b> Performs deep health checks at Layer 7 (e.g., looking for an HTTP <code>200 OK</code> on a specific route like <code>/health</code>).</div></li><li><div><b>NLB:</b> By default, performs standard TCP handshakes. If a port is open, the NLB marks it healthy, even if the underlying web application server is throwing <code>500 Internal Server Error</code> responses. To fix this, you must explicitly configure the NLB target group to use an HTTP/HTTPS health check option.</div></li></ul><h2>3. Troubleshooting Responses</h2><ul><li><div><b>HTTP 502 (Bad Gateway):</b> This means the ALB received an invalid response from the backend target. This usually indicates an application crash on the EC2 instance, or that the instance is returning an unreadable response format.</div></li><li><div><b>HTTP 503 (Service Unavailable):</b> This means the ALB has <b>no healthy targets</b> registered in its target groups, or the target groups are completely empty.</div></li><li><div><b>HTTP 504 (Gateway Timeout):</b> The backend target failed to respond within the idle timeout period. This points to a slow-running application, a database bottleneck, or an instance that dropped the connection without a response.&nbsp;</div></li></ul></div>',
    ...
    'Inspector': 'Automated vulnerability management that continually scans workloads for software vulnerabilities and exposure.&nbsp; Amazon Inspector <b>automatically discovers workloads</b>, such as Amazon Elastic Compute Cloud (Amazon EC2) instances, container images, and AWS Lambda functions, as well as code repositories, and <b>scans them for software vulnerabilities and unintended network exposure</b>.<div><div><div><div><div><div><div><div><div><span style="background-color: rgba(0, 0, 0, 0); color: rgb(22, 29, 38) !important;"></span></div></div></div></div></div></div></div></div></div><br>',
    ...
    'RDS': 'Managed relational database service supporting engines like MySQL, PostgreSQL, MariaDB, Oracle and SQL Server.<br><div><div>Examiners love testing your ability to distinguish between high availability, performance scaling, and cost optimization when dealing with databases.</div><div>Here are the highest-frequency RDS "gotchas" and wording traps you will encounter:</div><h3>1. The Multi-AZ vs. Read Replica Trap</h3><div>This is arguably the most common database trap on the exam.</div><ul><li><div><b>The Trap:</b> A scenario asks how to "improve read performance" or "offload heavy reporting queries" from the primary database, and offers Multi-AZ as an option.</div></li><li><div><b>The Reality:</b> Multi-AZ is strictly for <b>Disaster Recovery (DR) and High Availability (HA)</b>. The standby instance in a standard Multi-AZ deployment is completely passive and cannot serve read traffic.</div></li><li><div><b>The Solution:</b> If you need to scale read performance, you must choose <b>Read Replicas</b> (which use asynchronous replication).</div></li></ul><h3>2. Encrypting an Unencrypted Database</h3><ul><li><div><b>The Trap:</b> A scenario asks you to encrypt an existing, running RDS instance that was originally created without encryption, and offers a choice to "modify the instance and enable encryption."</div></li><li><div><b>The Reality:</b> You cannot enable encryption on an existing unencrypted RDS instance directly.</div></li><li><div><b>The Solution:</b> You must follow a specific sequence: Take a manual snapshot of the unencrypted database, copy the snapshot and select a KMS key to encrypt the copy, and finally restore a new RDS instance from the encrypted snapshot.</div></li></ul><h3>3. Backup Retention and Instance Deletion</h3><ul><li><div><b>The Trap:</b> A company wants to decommission an RDS instance but must retain the final state of the data for compliance reasons.</div></li><li><div><b>The Reality:</b> If you simply delete the database, all <b>automated backups</b> are deleted with it (unless you explicitly configure them to be retained, though the exam prefers the classic manual method).</div></li><li><div><b>The Solution:</b> You must take a <b>Manual DB Snapshot</b> before deleting the instance. Manual snapshots are never deleted automatically.</div></li></ul><h3>4. IAM Database Authentication</h3><ul><li><div><b>The Trap:</b> A scenario asks you to "minimize operational overhead for rotating database credentials" or securely authenticate EC2 instances to RDS without storing passwords in plain text.</div></li><li><div><b>The Solution:</b> Use <b>IAM Database Authentication</b>. It allows your applications to use short-lived authentication tokens (valid for 15 minutes) generated by IAM instead of traditional, static database passwords.</div></li></ul><h3>5. Amazon Aurora Edge Cases</h3><ul><li><div><b>Unpredictable Workloads:</b> If a scenario mentions a database workload with "infrequent, intermittent access" or "unpredictable spikes," and requires you to minimize costs, the answer is almost always <b>Amazon Aurora Serverless</b>.</div></li><li><div><b>Replica Limits:</b> Standard RDS (MySQL/PostgreSQL) allows up to 5 read replicas. Amazon Aurora allows up to 15 read replicas.</div></li></ul><div><b>The Architectural Takeaway</b></div><div>When you see an RDS question, immediately identify the core constraint. If the priority is surviving an Availability Zone failure, choose Multi-AZ. If the priority is handling a sudden spike in dashboard users, choose Read Replicas. If the workload is completely unpredictable, look toward Aurora Serverless.</div><div>Would you like to review the specific routing and failover differences between Aurora Custom Endpoints and Reader Endpoints next?</div></div>',
    ...
    'X-Ray': 'End-to-end distributed tracing that follows a request as it travels across microservices, serverless functions, and APIs. Each request becomes a trace built from segments/subsegments and drawn as a service map that pinpoints latency bottlenecks, errors, faults, and throttles; sampling keeps overhead low, and annotations let you filter traces by business attributes. Instrument with the X-Ray SDK or OpenTelemetry (ADOT), with near-zero-config tracing for Lambda, API Gateway, ECS/EKS, and App Mesh; traces tie into CloudWatch (ServiceLens) for unified observability.<br><br><b>Application Signals:</b> one-click setup with automatic instrumentation across Amazon ECS, EKS, Lambda, and EC2, plus prebuilt dashboards that surface your most critical telemetry.',
}
